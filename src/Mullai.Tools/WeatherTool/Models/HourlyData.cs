...
public class HourlyData
{
    ...
    [JsonPropertyName("dew_point_2m")] public List<double?> DewPoint2m { get; set; } = new();
    ...
    [JsonPropertyName("snow_depth")] public List<double?> SnowDepth { get; set; } = new();

    [JsonPropertyName("weather_code")] public List<int?> WeatherCode { get; set; } = new();

    [JsonPropertyName("pressure_msl")] public List<double?> PressureMsl { get; set; } = new();

    [JsonPropertyName("surface_pressure")] public List<double?> SurfacePressure { get; set; } = new();

    [JsonPropertyName("cloud_cover_low")] public List<int?> CloudCoverLow { get; set; } = new();

    [JsonPropertyName("cloud_cover")] public List<int?> CloudCover { get; set; } = new();

    [JsonPropertyName("cloud_cover_mid")] public List<int?> CloudCoverMid { get; set; } = new();

    [JsonPropertyName("cloud_cover_high")] public List<int?> CloudCoverHigh { get; set; } = new();
    ...
    [JsonPropertyName("temperature_180m")] public List<double?> Temperature180m { get; set; } = new();

    [JsonPropertyName("temperature_120m")] public List<double?> Temperature120m { get; set; } = new();

    [JsonPropertyName("temperature_80m")] public List<double?> Temperature80m { get; set; } = new();

    [JsonPropertyName("wind_gusts_10m")] public List<double?> WindGusts10m { get; set; } = new();
    ...
    [JsonPropertyName("wind_speed_180m")] public List<double?> WindSpeed180m { get; set; } = new();

    [JsonPropertyName("wind_speed_120m")] public List<double?> WindSpeed120m { get; set; } = new();

    [JsonPropertyName("wind_speed_80m")] public List<double?> WindSpeed80m { get; set; } = new();

    [JsonPropertyName("wind_speed_10m")] public List<double?> WindSpeed10m { get; set; } = new();
    ...
    [JsonPropertyName("uv_index")] public List<double?> UvIndex { get; set; } = new();
    ...
    [JsonPropertyName("lifted_index")] public List<double?> LiftedIndex { get; set; } = new();
