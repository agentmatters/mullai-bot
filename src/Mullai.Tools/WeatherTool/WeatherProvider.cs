...
public class WeatherProvider
{
    ...
    public async Task<string> GetWeatherAsync(string location)
    {
        ...
        if (coordinates == null) return $"Location '{location}' not found.";
        ...
        if (forecast == null || forecast.Hourly.Time.Count == 0) return $"No weather data available for {location}.";
    ...
    /// </summary>
    private static string FormatWeatherData(string location, WeatherForecastResponse forecast, double latitude,
        double longitude)
    {
