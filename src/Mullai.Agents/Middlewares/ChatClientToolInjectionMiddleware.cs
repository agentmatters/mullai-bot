...
public class ChatClientToolInjectionMiddleware : DelegatingChatClient
{
    ...
    private readonly Func<AIAgent, FunctionInvocationContext, Func<FunctionInvocationContext, CancellationToken, ValueTask<object?>>, CancellationToken, ValueTask<object?>> _middlewareCallback;
    ...
    public ChatClientToolInjectionMiddleware(
        ...
        Func<AIAgent, FunctionInvocationContext, Func<FunctionInvocationContext, CancellationToken, ValueTask<object?>>, CancellationToken, ValueTask<object?>> middlewareCallback)
        : base(innerClient)
    {
